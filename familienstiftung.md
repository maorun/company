...
- **Keine Gesellschafter:** Keine Anteile oder Mitgliedschaften
...
- Können Stifter und deren Nachkommen sein
...
### Erweiterbarkeit auf mehrere Personen
...
## Vermögensanlage in Aktien und ETFs

### Anlagestrategie mit max. 4 Transaktionen/Jahr
...
#### Muster-Portfolio für Familienstiftung

**Beispiel mit 500.000 € Stiftungsvermögen:**

| Position | Art | Allokation | Betrag |
|----------|-----|------------|--------|
| DAX-Dividendenwerte (3-4 Aktien) | Einzelaktien | 25% | 125.000 € |
| Internationale Qualitätstitel (3-4 Aktien) | Einzelaktien | 20% | 100.000 € |
| MSCI World ETF | ETF | 30% | 150.000 € |
| Dividend Aristocrats ETF | ETF | 15% | 75.000 € |
| Liquidität | Cash | 10% | 50.000 € |
| **Gesamt** | | **100%** | **500.000 €** |
...
### Erbschaftsteuer-Ersatzbesteuerung (§ 1 Abs. 1 Nr. 4 ErbStG)
...
- **Effektiver Steuersatz:** ca. 7-30% (abhängig vom Vermögen)
...
- **Vorteil:** Nur Kapitalertragsteuer auf Dividenden, keine zusätzliche Belastung
...
- **Vorteil:** Steuerfreier Zinseszinseffekt über 30 Jahre
...
- Ggf. temporär in schwankungsarme Anlagen umschichten
...
**Gesamtkosten Gründung: ca. 3.000-8.000 €**
...
**Gesamtkosten laufend: ca. 3.000-8.000 €/Jahr**
...
### Kostenschätzung nach Vermögen

| Stiftungsvermögen | Jährliche Kosten | Kostenquote |
|-------------------|------------------|-------------|
| 100.000 € | 3.000-5.000 € | 3-5% |
| 250.000 € | 3.500-6.000 € | 1,4-2,4% |
| 500.000 € | 4.000-8.000 € | 0,8-1,6% |
| 1.000.000 € | 5.000-10.000 € | 0,5-1,0% |
| 2.500.000 € | 7.000-15.000 € | 0,3-0,6% |

**Fazit:** Ab ca. 250.000-500.000 € Vermögen wird die Kostenquote vertretbar.
...
- Prüfung bei Verdacht auf Missbrauch
...
- Steuerberater mit Stiftungs-Expertise hinzuziehen
...
- Langfristige Anlagestrategie möglich
...
- Fehlerrisiko bei Laien-Verwaltung
...
- Organe festlegen (Vorstand, Stiftungsrat)
- Ausschüttungsregelungen
- Anlagerichtlinien (optional)
...
- Bericht an Stiftungsbehörde vorbereiten
...
Sie hat ihren Sitz in [Stadt].

§ 2 Stiftungszweck

Zweck der Stiftung ist die Verwaltung und Vermehrung des Stiftungsvermögens 
sowie die Unterstützung und Versorgung der Destinatäre.

§ 3 Destinatäre

Destinatäre der Stiftung sind:
1. Der Stifter [Name], geboren am [Datum]
2. [Weitere Personen oder: "Alle Abkömmlinge des Stifters"]

Der Vorstand kann mit Zustimmung des Stiftungsrats weitere Personen als 
Destinatäre bestimmen, sofern sie zur Familie des Stifters gehören.

§ 4 Vermögensverwendung

Die Erträge des Stiftungsvermögens können ganz oder teilweise an die 
Destinatäre ausgeschüttet werden. Der Vorstand entscheidet nach pflichtgemäßem 
Ermessen über Höhe und Zeitpunkt der Ausschüttungen.

Das Grundstockvermögen ist zu erhalten. Wertsteigerungen können dem 
Grundstockvermögen zugeschlagen oder als Erträge behandelt werden.
...
Der Vorstand besteht aus [1-3] Mitgliedern. Die Stiftung wird durch 
[ein Vorstandsmitglied allein / zwei Vorstandsmitglieder gemeinsam] vertreten.

Erster Vorstand ist [Name des Stifters].

§ 7 Anlagerichtlinien

Das Stiftungsvermögen ist nach den Grundsätzen ordnungsgemäßer Vermögensverwaltung 
anzulegen. Eine Anlage in Wertpapieren (Aktien, ETFs) ist zulässig.
...
### Übersicht Vermögensstrukturen

| Kriterium | Privatvermögen | UG/GmbH | Familienstiftung |
|-----------|----------------|---------|------------------|
| Gründungskosten | 0 € | 200-1.000 € | 3.000-8.000 € |
| Laufende Kosten/Jahr | 0 € | 2.500-4.000 € | 3.000-8.000 € |
| Steuer auf Dividenden | 26,375% | 1,5% (mit §8b) | 25% |
| Steuer auf Kursgewinne | 26,375% | 1,5% (mit §8b) | 0% laufend |
| Erbschaftsteuer | Alle 25-30 Jahre | Alle 25-30 Jahre | Alle 30 Jahre (integriert) |
| Vermögensschutz | Gering | Mittel | Hoch |
| Flexibilität | Sehr hoch | Hoch | Gering |
| Verwaltungsaufwand | Minimal | Mittel | Hoch |
| Geeignet ab Vermögen | 0 € | 100.000-200.000 € | 250.000-500.000 € |
...
- Langfristige Anlagestrategie (>30 Jahre)
...
- [ ] Steuerberater mit Stiftungs-Expertise mandatiert
- [ ] Rechtsanwalt für Satzungsgestaltung beauftragt
- [ ] Satzungsentwurf erstellt und geprüft
- [ ] Organe definiert (Vorstand, ggf. Stiftungsrat)
- [ ] Anlagerichtlinien formuliert
...
- [ ] Erstkäufe durchgeführt (Jahr 1)
- [ ] Diversifikation aufgebaut (Jahr 2-3)
- [ ] Dividendenstrategie implementiert
...
- [ ] Dividendenbescheinigungen gesammelt
- [ ] Jahresabschluss erstellt (innerhalb 6 Monate)
- [ ] Bericht an Stiftungsbehörde eingereicht
- [ ] Steuererklärungen abgegeben
- [ ] Vorstandssitzung durchgeführt (mind. jährlich)
- [ ] Protokolle aller Beschlüsse erstellt
...
- [ ] Trennung von Stiftungs- und Privatvermögen
- [ ] Max. 4 Transaktionen/Jahr eingehalten
...
- [ ] Stiftungsrat einrichten (falls gewünscht)
- [ ] Beirat etablieren (optional)
- [ ] Governance-Strukturen dokumentieren
- [ ] Ausschüttungsregeln für mehrere Personen definieren
...
### Optimale Strategie für Ihr Szenario

**Ausgangssituation: 1 Person, Vermögen in Aktien/ETFs, max. 4 Transaktionen/Jahr**

1. **Start als Einzelperson-Familienstiftung:**
   - Stifter als alleiniger Vorstand und Destinatär
   - Satzung mit breiter Destinatärs-Definition für spätere Erweiterung
   - Klare Anlagerichtlinien: max. 4 Transaktionen/Jahr

2. **Portfolio-Aufbau (Jahr 1-3):**
   - Mix aus 6-8 Einzelaktien und 2-3 ETFs
   - Fokus auf Dividendenwerte und Qualitätswachstum
   - Jährlich 4 Transaktionen für Aufbau

3. **Langfristige Strategie (ab Jahr 4):**
   - Buy-and-Hold mit minimalen Umschichtungen
   - 1-2 Transaktionen/Jahr für Optimierung
   - Thesaurierung der Erträge für Vermögensaufbau
   - Kein/minimaler Zugriff auf Kapital

4. **Erweiterung auf Familie (flexibel):**
   - Bei Heirat: Ehepartner als Destinatär
   - Bei Kindern: Automatisch als Destinatäre (falls Satzung entsprechend)
   - Optional: Stiftungsrat mit Familienvertretern
   - Nächste Generation in Vorstand/Stiftungsrat einbinden

5. **Steueroptimierung:**
   - Kursgewinne bevorzugen (nicht laufend besteuert)
   - Bei 30-Jahres-Frist: Portfolio-Struktur optimieren
   - Freibeträge (800.000 €) ausnutzen
...
- Aktives Trading gewünscht (>4 Transaktionen/Jahr)
- Verwaltungsaufwand zu hoch
- Keine Nachfolgeplanung relevant

## Weiterführende Informationen

### Relevante Gesetze

- **§§ 80-88 BGB:** Stiftungsrecht
- **§ 1 Abs. 1 Nr. 4 ErbStG:** Erbschaftsteuerersatzbesteuerung
- **§ 10 ErbStG:** Freibeträge
- **§ 20 Abs. 1 Nr. 9 EStG:** Besteuerung von Destinatären
- **Landesstiftungsgesetze:** Je nach Bundesland

### Wichtige Links

- [Bundesverband Deutscher Stiftungen](https://www.stiftungen.org)
- [Stiftungsgesetze der Länder](https://www.stiftungen.org/stiftungen/grundlagen/stiftungsrecht.html)
- [Bundesministerium der Finanzen - Erbschaftsteuer](https://www.bundesfinanzministerium.de)
- [Bundesministerium der Justiz - BGB §§ 80ff](https://www.gesetze-im-internet.de/bgb/)
...
- **Stiftungsberater** für Strukturfragen
